/*
 * @fileoverview {FunctionTester}, se encarga de realizar tareas especificas.
 *
 * @version             1.0
 *
 ...
 *
 * @history v1.0 --- La implementacion de {FunctionTester} fue realizada el 14/08/2022.
 * @dev - La primera version de {FunctionTester} fue escrita por Dyson A. Parra T.
 */
